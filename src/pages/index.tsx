...
const Page: React.FC<PageProps> = () => {
    ...
    const testConnection = async () => {
        ...
        if (error) {
            ...
            alert(`✅ Success! Part created with ID: ${data[0].id}`);
        }
    };
        ...
        <div className="bg-black text-light min-vh-100 pb-5">
            ...
            <main>
                <Container>
                    ...
                    {/* SECTION: SUPABASE TEST BUTTON */}
                    <div className="mt-5 p-4 border border-secondary text-center">
                        <h3>Backend Connection Test</h3>
                        <button className="btn btn-info" onClick={testConnection}>Run Connection Test</button>
                    </div>
                </Container>
            </main>
